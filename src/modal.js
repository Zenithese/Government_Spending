                                                    ...
                                                    <div id="myModal" class="modal">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p>In the spirit of transparency, consider the different types of federal spending, mainly: discretionary and mandatory. Discretionary spendings are decided via an appropriation process by congress every year, whereas mandatory do not require that same yearly process as they are written into law. Addtionally, tax breaks are considered tax expenditures (i.e. the sacrificed tax revenue benefit specific economic sectors/groups/initiatives). These considerations would be a healthy addition, and are being considered for future development.</p>
                                                            </div>
